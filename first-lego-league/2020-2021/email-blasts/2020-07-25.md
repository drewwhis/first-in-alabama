...
Each division will have their own events, activities, rules, and so on, but from now on we are one, big *FIRST*® LEGO® League family! We have more information captured on our [program structure page](https://github.com/drewwhis/first-in-alabama/tree/main/first-lego-league/2020-2021/program-structure.md).
